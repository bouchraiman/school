...
<head>
    <meta charset="UTF-8"/>
    <title>Espace Etudiant - ALLAL SCHOOL</title>
        ...
        <main>
            <section class="profile">
                <div class="profile-info">
                    <img src="téléchargement (2).jpeg" alt="Photo de profil" class="profile-pic">
                    <div class="details">
                        <p><strong>Nom:</strong> Messani</p>
                        <p><strong>Prénom:</strong> bouchra</p>
                        <p><strong>Date de naissance:</strong> 09/02/2003</p>
                        <p><strong>Email:</strong> bouchra@gmail.com</p>
