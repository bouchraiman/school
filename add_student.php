...
<head>
    <meta charset="UTF-8"/>
    <title>Ajouter un Apprenant - ALLAL SCHOOL</title>
...
<nav>
    <ul>
        <li><a href="administrateur.php"><i class='bx bxs-school'></i><span class="nav-item">Administration</span></a></li>
...
<div class="main--content">
    ...
    <form action="process_add_student.php" method="POST">
        ...
        <label for="classe">date_naissance</label>
