        ...
        <main>
            <section class="profile">
                <div class="profile-info">
                    ...
                    <div class="details">
                        <p><strong>Nom:</strong> Nasri</p>
                        <p><strong>Prénom:</strong> Maroua</p>
                        <p><strong>Date de naissance:</strong> 04/12/2003</p>
                        <p><strong>Email:</strong> Maroua.nasri@gmail.com</p>
                        <p><strong>Adresse:</strong>Elbayadh</p>
                        <p><strong>Grade:</strong>Prof de Français</p>
